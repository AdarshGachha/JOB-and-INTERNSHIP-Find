...
{employe && (
  <div className="p-10" key={employe._id}>
    <div className="mb-5 flex items-center gap-x-3">
                    <img
                      onClick={ChangeProfile}
                      aria-hidden="true"
                      className="h-20 w-20h-20 rounded-full"
  ...
  <form onSubmit={employeUpdateHandler}>
    ...
    <div className="mt-6 flex items-center justify-end gap-x-6">
      ...
      <button
        type="submit"
        className="rounded-md bg-indigo-600 px-6 py-3 text-[15px] font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
      >
        Update
      </button>
    </div>
